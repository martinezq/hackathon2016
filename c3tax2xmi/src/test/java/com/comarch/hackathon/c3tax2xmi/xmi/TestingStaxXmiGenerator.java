...
public class TestingStaxXmiGenerator {
	...
	public TestingStaxXmiGenerator(Collection<RdfSubject> subjects) {
	...
	private void writeClassStart(String id, RdfSubject subject) throws XMLStreamException {
		...
		//XmiGeneratorUtil.link("Test link", "http://www.comarch.pl")
		writeComment(UUID.randomUUID().toString(), "<a href=\"http://192.168.1.25/em/index.php/Interface_Points\">Link</a>", id);
	}
