...
public abstract class XmiObject {
	...
	public abstract void serialize(XMLStreamWriter writer) throws XMLStreamException;

	public static void writeComment(XMLStreamWriter writer, String id, String text, String refId) throws XMLStreamException {
/*
 ...
 */
	...
	public static void writeDependency(XMLStreamWriter writer, String id, String name, String fromRefId, String toRefId) throws XMLStreamException {
	...
	public static void writeProperty(XMLStreamWriter writer, String id, String name, String type) throws XMLStreamException {
		/*
